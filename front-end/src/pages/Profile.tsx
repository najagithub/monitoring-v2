...
export const Profile: React.FC = () => {
  ...
  // preview (URL pour l'affichage)
  const [profileImagePreview, setProfileImagePreview] = useState<string>(initialProfileImageUrl);
  ...
  return (
        ...
        <div className="p-6 bg-gradient-to-r from-blue-500 to-blue-600">
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <div className="relative">
              <img
                  src={profileImagePreview || "https://via.placeholder.com/96"}
            ...
            <div className="text-center sm:text-left">
              <h2 className="text-2xl font-bold text-white">{profileData.name || user?.username || "Utilisateur"}
              </h2>
    ...
    ${isSavingProfile ? "bg-blue-400 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700"} text-white`}
              >
                {isSavingProfile ? (
                    <>
                      <Spinner />
          ...
          {activeTab === 'password' && (
            <form onSubmit={handlePasswordSubmit} className="space-y-6">
              ...
              <button
                  ...
                  className={`w-full sm:w-auto flex items-center justify-center gap-2 font-semibold px-6 py-3 rounded-lg transition shadow-lg hover:shadow-xl
                ${isSavingPassword ? "bg-blue-400 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700"} text-white`}
              >
                {isSavingPassword ? (
                    <>
                      <Spinner />
